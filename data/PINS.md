...
| Nannūl (complete, 1–462) | projectmadurai.org/pm_etexts/utf8/pmuni0147.html · sha256 `bfc865ddc2e4…` | 2026-08-02 | ″ |
...
(எழுத்ததிகாரம்/புணரியல், சொல்லதிகாரம்/வேற்றுமையியல்) are gap-free. Nannūl 460 of 462 — நூற்பா 73
and 176 are absent from the upstream etext itself (72→74, 175→177), recorded and never
reconstructed. Four verses elsewhere in பொருளதிகாரம்/வினையியல் likewise unextracted; see the
`coverage` block in each artifact.
